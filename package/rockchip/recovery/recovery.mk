...
ifeq ($(BR2_PACKAGE_RECOVERY_USE_ROTATION_LEFT),y)
	TARGET_CFLAGS += -DUSE_ROTATION_LEFT=ON
endif

ifeq ($(BR2_PACKAGE_RECOVERY_USE_ROTATION_RIGHT),y)
	TARGET_CFLAGS += -DUSE_ROTATION_RIGHT=ON
endif

ifeq ($(BR2_PACKAGE_RECOVERY_USE_ROTATION_DOWN),y)
	TARGET_CFLAGS += -DUSE_ROTATION_DOWN=ON
endif
